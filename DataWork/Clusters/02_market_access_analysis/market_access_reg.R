...
#10km
reg9 <- lm(diff_ntl~diff_noexclusion ,data = cluster_df_20km)
reg10 <- lm(diff_ntl~diff_exclude10km ,data = cluster_df_20km)
reg11 <- lm(diff_ntl~diff_exclude20km ,data = cluster_df_20km)
reg12 <- lm(diff_ntl~diff_exclude50km,data = cluster_df_20km)
