...
# Subset Data -------------------------------------------------------------
vars <- c("uid","viirs_mean","viirs_time_id","year","month","ADM3_EN",
          "ADM2_EN","ADM2_EN","ADM1_EN", "no_of_conflicts","avg_hh_exp.mean",
          "no_of_conflicts","transformed_viirs_mean","roadimprovement","pop_new","missing")
