...
ntl_subdist$pop_new[ntl_subdist$year == 2016] <- ntl_subdist$population[ntl_subdist$year == 2015]*(1+2.5)
ntl_subdist$pop_new[ntl_subdist$year == 2017] <- ntl_subdist$pop_new[ntl_subdist$year == 2016]*(1+2.5)
ntl_subdist$pop_new[ntl_subdist$year == 2018] <- ntl_subdist$pop_new[ntl_subdist$year == 2017]*(1+2.5)
ntl_subdist$pop_new[ntl_subdist$year == 2019] <- ntl_subdist$pop_new[ntl_subdist$year == 2018]*(1+2.5)
