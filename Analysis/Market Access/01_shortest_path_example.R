...
# Load Data --------------------------------------------------------------------
iraq_adm3 <- readRDS(file.path(final_data_file_path, "subdistrict_data", "subdistrict_population.Rds"))
...
for(i in 1:nrow(path)){
  ...
  ggsave(p_speed_path, filename = file.path(figures_file_path, "shortest_path_figures", paste0("shortest_path_example_",i,".png")), height = 4, width = 10)
