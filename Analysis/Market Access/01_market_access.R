...
ggsave(filename = file.path(figures_file_path, "road_length_hist.png"), height=6, width=6)
...
ggsave(p1, filename = file.path(figures_file_path, "market_access_3_8.png"), height=6, width=6)
ggsave(p2, filename = file.path(figures_file_path, "market_access_3_8_exclude100km.png"), height=6, width=6)
...
p_northsouth <- ggarrange(p_north_3_8 , p_south_3_8, common.legend=T,
                          legend="bottom")
ggsave(p_northsouth, filename = file.path(figures_file_path, "market_access_northsouth.png"), height=6, width=12)

p_northsouth_exclude <- ggarrange(p_north_3_8_exclude , p_south_3_8_exclude, common.legend=T,
                          legend="bottom")
ggsave(p_northsouth_exclude, filename = file.path(figures_file_path, "market_access_northsouth_exclude.png"), height=6, width=12)
